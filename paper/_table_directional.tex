\begin{table}[htbp]
  \caption{Absolute versus directional controllability for all 40 points.
  ...
  \begin{tabular}{llccc}
    ...
    \midrule
    \texttt{certainty} & Gemma-2-9b & $0.054$ & $-0.035$ & $-0.30$ \\
    ...
    \texttt{factuality} & Gemma-2-9b & $0.054$ & $-0.050$ & $-0.88$ \\
    ...
    \texttt{formality} & Gemma-2-9b & $0.020$ & $-0.006$ & $-0.27$ \\
    ...
    \texttt{honesty} & Gemma-2-9b & $0.079$ & $+0.016$ & $+0.22$ \\
    ...
    \texttt{refusal} & Gemma-2-9b & $0.038$ & $+0.038$ & $+0.90$ \\
    ...
    \texttt{rudeness} & Gemma-2-9b & $0.069$ & $+0.023$ & $+0.42$ \\
    ...
    \texttt{sentiment} & Gemma-2-9b & $0.110$ & $-0.039$ & $-0.68$ \\
    ...
    \texttt{sycophancy} & Gemma-2-9b & $0.015$ & $+0.009$ & $+0.52$ \\
    ...
    \texttt{topic\_science} & Gemma-2-9b & $0.007$ & $+0.005$ & $+0.70$ \\
    ...
    \texttt{verbosity} & Gemma-2-9b & $0.041$ & $+0.022$ & $+0.68$ \\
