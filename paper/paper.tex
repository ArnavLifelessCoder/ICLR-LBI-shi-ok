...
of 40 signs against the rule's 26, the judge's resolutions concentrate on the one
concept where it is validated against a human rater, and judge-scored magnitudes
...
concept on which the judge agrees with a human rater (Krippendorff's
...
\texttt{sentiment} four times in four, where it agrees with a human, and ten times
in thirty-six elsewhere. That is consistent with the judge limiting what can be
...
protocol an LLM judge resolves a sign about half as often, mostly on the one
concept where it is validated, and its magnitudes do not survive a change of
